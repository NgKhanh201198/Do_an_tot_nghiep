...
CREATE TABLE BOOKINGRATE (BOOKINGRATEID SERIAL PRIMARY KEY,
...
CREATE TABLE BOOKINGROOM(BOOKINGROOMID SERIAL PRIMARY KEY,
						...
						TOTALROOMSBOOKED SERIAL, 
						TOTALCOST SERIAL,
						STATUS CHARACTER VARYING(255) NOT NULL,
						DATE_CREATED TIMESTAMP,
						UPDATED_DATE TIMESTAMP,
						BOOKINGRATEID SERIAL NOT NULL);
						
CREATE TABLE ROOM_BOOKED(BOOKINGRATEID SERIAL NOT NULL,
						 ROOMID SERIAL NOT NULL,
						 PRIMARY KEY(BOOKINGRATEID, ROOMID));
...
ALTER TABLE BOOKINGROOM ADD CONSTRAINT FK_BOOKINGROOM_BOOKINGRATE
FOREIGN KEY (BOOKINGRATEID) REFERENCES BOOKINGRATE (BOOKINGRATEID);

ALTER TABLE BOOKINGRATE ADD CONSTRAINT FK_BOOKINGRATE_USERS
FOREIGN KEY (USERID) REFERENCES USERS (USERID);
...
ALTER TABLE ROOM_BOOKED ADD CONSTRAINT FK_ROOM_BOOKED_BOOKINGRATE
FOREIGN KEY (BOOKINGRATEID) REFERENCES BOOKINGRATE (BOOKINGRATEID);
